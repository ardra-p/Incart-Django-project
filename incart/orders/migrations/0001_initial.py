    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.IntegerField(choices=[(2, 'ORDER_PROCESSED'), (3, 'ORDER_DELIVERED'), (-1, 'ORDER_REJECTED')], default=1)),
                ('detele_status', models.IntegerField(choices=[(1, 'Live'), (0, 'Delete')], default=1)),
